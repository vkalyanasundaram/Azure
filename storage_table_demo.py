...
storageaccount_name = 'vks'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'westus'
...
items = table_service.query_entities('itemstable', filter="PartitionKey eq 'cafe'", select='brand,flavor,size,price')
for item in items:
